    ...
    <div className={styles.dialog}>
      <div className={styles.header}>
          <div className={ styles.header_stickers }>
            <img src={ new URL('icons/72x72.png', window.location.origin).toString() } srcSet={ new URL('images/144x144.png', window.location.origin).toString() + ' 2x' } width={72} height={72} alt="Viajar com Alê Icon" />
