    ...
    <div className={styles.dialog}>
      <div className={styles.header}>
          <div className={ styles.header_stickers }>
            <img src={ new URL('icons/72x72.png', window.location.origin).toString() } srcSet={ new URL('icons/any.svg', window.location.origin).toString() } width={72} height={72} alt="Viajar com Alê Icon" />
