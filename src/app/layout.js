...
export default function RootLayout({ children }) {
  ...
  return (
    <html lang={ i18n('en') }>
      ...
      <Script id="ld-website" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"http://schema.org","@type":"WebSite","url":host(''),"author":"Alefe Souza","name":"Viajar com Alê","alternateName":"Viajar com Alê","description":i18n('Links to Viajar com Alê social networks.'),"potentialAction":{"@type":"SearchAction","target":host('') + "?s={search_term_string}","query-input":"required name=search_term_string"}}) }}></Script>
